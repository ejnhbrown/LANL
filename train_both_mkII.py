...
#
# dir = 'test_extract/test_chunk_data/'
...
xgb_params = {'eta': 0.03, 'max_depth': 10, 'subsample': 0.9, #'colsample_bytree': 0.8,
...
dump(model,open('benchmarkcnnII.pkl.dat', 'wb'))
...
submission.to_csv('subtestII.csv',index=False)
